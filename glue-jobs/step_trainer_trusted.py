...
StepTrainerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "paths": ["s3://udacity-project-jimmy/step-trainer/landing/"],
        "recurse": True,
    },
...
StepTrainerTrusted_node5 = glueContext.getSink(
    path="s3://udacity-project-jimmy/step-trainer/trusted/",
    connection_type="s3",
    updateBehavior="UPDATE_IN_DATABASE",
    partitionKeys=[],
    enableUpdateCatalog=True,
    transformation_ctx="StepTrainerTrusted_node5",
)
StepTrainerTrusted_node5.setCatalogInfo(
    catalogDatabase="stedi", catalogTableName="step_trainer_trusted"
)
StepTrainerTrusted_node5.setFormat("json")
StepTrainerTrusted_node5.writeFrame(DropFields_node4)
