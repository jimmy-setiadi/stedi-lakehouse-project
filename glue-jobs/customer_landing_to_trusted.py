...
# Script generated for node S3 bucket - Customer Landing
S3bucket_CustomerLanding_node1 = glueContext.create_dynamic_frame.from_options(
    format_options={"multiline": False},
    connection_type="s3",
    format="json",
    connection_options={
        "paths": ["s3://udacity-project-jimmy/customer/landing/"],
        "recurse": True,
    },
    transformation_ctx="S3bucket_CustomerLanding_node1",
)

# Script generated for node Privacy Filter
PrivacyFilter_node2 = Filter.apply(
    frame=S3bucket_CustomerLanding_node1,
...
TrustedCustomerZone_node3 = glueContext.getSink(
    path="s3://udacity-project-jimmy/customer/trusted/",
    connection_type="s3",
